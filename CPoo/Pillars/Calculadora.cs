...
namespace Avanade.cs.Design
{
    public class Calculadora : ICalculator
    {
        ...
        int ICalculator.Somar(int num1, int num2)
        {
            return num1 + num2;
        }

        int ICalculator.Subtrair(int num1, int num2)
        {
            return  num1 - num2;      
        }

        int ICalculator.Multiplicar(int num1, int num2)
        {
            return num1 * num2;
        }

        int ICalculator.Dividir(int num1, int num2)
        {
            return num1 / num2;
        }
    }
